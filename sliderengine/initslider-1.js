jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"tiles,elastic,threedflipwithzoom,threedwithzoom,threedflip,cssslide,threedtiles,slide,crossfade,threedhorizontalwithzoom,shuffle,threedhorizontal,blinds",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
